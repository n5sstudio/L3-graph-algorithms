...
// Fonction MAIN
  // On fait ici une s�rie de test permettant de v�rifier si le programme est coh�rent
...
/* Notes Suppl�mentaires :
 - Les Fonctions Union, Composition et Sousgraphe n'ont pas �t� compl�tement termin�e et ne figurent pas dans le script ci-dessus.
 - Tous les cas n'ont pas pu �tre trait� par manque de temps afin de v�rifier correctement les fonctions de R�flexivit�, Sym�trie, Transitivit�.
 */
